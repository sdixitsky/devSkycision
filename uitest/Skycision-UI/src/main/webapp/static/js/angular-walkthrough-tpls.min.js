(function(window, document, undefined) {
    ...
    angular.module("wt-popover-toolbar.html", []).run(["$templateCache",
    ...
    angular.module('angular-walkthrough')
        .directive('wtStep', ['$compile', '$q', '$document', '$templateCache', '$timeout',
            function($compile, $q, $document, $templateCache, $timeout) {
                return {
                    restrict: 'A',
    ...
    angular.module('angular-walkthrough')
        .controller('WalkThroughController', ['$scope', '$rootScope', '$q',
            function($scope, $rootScope, $q) {
                ...
                self._addHelperLayer = function(element) {
                    $scope._addHelperLayer(element);
                }
                self._removeHelperLayer = function() {
                    $scope._removeHelperLayer();
                }
                self._addCoverLayer = function(element) {
                    $scope._addCoverLayer(element);
                }
                self._removeCoverLayer = function() {
                    $scope._removeCoverLayer();
                }
                self._addOverlayLayer = function(element) {
                    $scope._addOverlayLayer(element);
                }
                self._removeOverlayLayer = function() {
                    $scope._removeOverlayLayer();
                }
    ...
    angular.module('angular-walkthrough')
        .directive('walkthrough', ['$rootScope', '$document',
            function($rootScope, $document) {
                return {
                    ...
                    link: function(scope, element, attrs, WalkThroughController) {
                        ...
                        if ('wtCancel' in attrs) {
                            scope.wtCancel = WalkThroughController.cancel;
                        }
