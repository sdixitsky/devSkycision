...
(function (factory) {
  ...
  angular.module('ui.bootstrap.datetimepicker', [])
    ...
    .directive('dropdowndatetimepicker', DropdownDateTimePicker);
  ...
  DropdownDateTimePicker.$inject = ['TEMPLATE_DIR']; 
  function DropdownDateTimePicker(TEMPLATE_DIR) {
    return {
      restrict: 'E',
      transclude: true,
      replace:true,
      ...
      templateUrl: TEMPLATE_DIR + 'dropdowndatetimepicker.partial.html',
      link: DropdownDateTimePickerController
    }
    DropdownDateTimePickerController.$inject = ['$scope', '$element', '$attrs', '$controller', '$transclude']; 
    function DropdownDateTimePickerController($scope, $element, $attrs, $controller, $transclude) {
        $element.find('.datetimecontent').append($transclude());
    }
  }
