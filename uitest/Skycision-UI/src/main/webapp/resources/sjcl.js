...
sjcl.bitArray = {
    bitSlice: function(a, b, c) { a = sjcl.bitArray.$(a.slice(b / 32), 32 - (b & 31)).slice(1);
...
sjcl.codec.base32 = {
    ...
    toBits: function(a, b) {
        ...
        for (g = 0; g < a.length; g++) { n = k.indexOf(a.charAt(g));
            if (0 > n) {
                if (!b) try {
                    return sjcl.codec.base32hex.toBits(a) } catch (p) {}
...
sjcl.codec.base32hex = { fromBits: function(a, b) {
        return sjcl.codec.base32.fromBits(a, b, 1) }, toBits: function(a) {
    ...
    update: function(a) { "string" === typeof a && (a = sjcl.codec.utf8String.toBits(a));
        ...
        if ("undefined" !== typeof Uint32Array) {
            var d = new Uint32Array(c),
                e = 0;
            for (b = 512 + b & -512; b <= a; b += 512) u(this, d.subarray(16 * e, 16 * (e + 1))), e += 1;
            c.splice(0, 16 * e) } else
...
sjcl.misc.hmac = function(a, b) { this.W = b = b || sjcl.hash.sha256;
    var c = [
            [],
            []
        ],
...
sjcl.misc.pbkdf2 = function(a, b, c, d, e) { c = c || 1E3;
    if (0 > d || 0 > c) throw sjcl.exception.invalid("invalid params to pbkdf2"); "string" === typeof a && (a = sjcl.codec.utf8String.toBits(a)); "string" === typeof b && (b = sjcl.codec.utf8String.toBits(b));
    e = e || sjcl.misc.hmac;
    a = new e(a);
    var f, g, h, k, l = [],
        n = sjcl.bitArray;
    for (k = 1; 32 * l.length < (d || 1); k++) { e = f = a.encrypt(n.concat(b, [k]));
        for (g = 1; g < c; g++)
...
sjcl.prng.prototype = {
    ...
    getProgress: function(a) { a = this.T[a ? a : this.M];
    ...
    oa: function(a) {
        var b, c;
        try { b = a.x || a.clientX || a.offsetX || 0, c = a.y || a.clientY || a.offsetY || 0 } catch (d) { c = b = 0 }
    ...
    ea: function(a) { a = a.accelerationIncludingGravity.x || a.accelerationIncludingGravity.y || a.accelerationIncludingGravity.z;
